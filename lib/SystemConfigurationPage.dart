                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'System Settings', // edit logo msln change color
                          style: TextStyle(
                            fontSize: 20.0,
                            fontWeight: FontWeight.bold,
                        ...
                        TextFormField(
                          decoration:
                              InputDecoration(labelText: 'System Setting 1'),
                        ),
                        SizedBox(height: 8.0),
                        TextFormField(
                          decoration:
                              InputDecoration(labelText: 'System Setting 2'),
                        ),
                      ],
                    ),
                  ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          decoration:
                              InputDecoration(labelText: 'Chatbot Setting 1'),
                        ),
                      ],
                    ),
                  ),
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Recommendation Criteria', //add info, additional apperance to user
                          style: TextStyle(
                            fontSize: 20.0,
                            fontWeight: FontWeight.bold,
                            color: Color(0xFF3B52BB),
