        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              value: widget.selectedEducationalLevel.text.isNotEmpty ? widget.selectedEducationalLevel.text : null,
              onChanged: (value) {
                setState(() {
            ...
            DropdownButtonFormField<String>(
              value: widget.selectedJobStatus.text.isNotEmpty ? widget.selectedJobStatus.text : null,
              onChanged: (value) {
                setState(() {
            ...
            DropdownButtonFormField<String>(
              value: widget.selectedFieldOfInterests.text.isNotEmpty ? widget.selectedFieldOfInterests.text : null,
              onChanged: (value) {
                setState(() {
